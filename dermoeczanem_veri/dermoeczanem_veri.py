...
class AllDermoSpider(Spider):
    name = "all_dermoeczanem"
    allowed_domains = ["dermoeczanem.com"]

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.target_barcode = "3461020002929"
        with open("categories_dermoeczanem.json", "r", encoding="utf-8") as f:
...
process = CrawlerProcess(settings={
    "FEEDS": {
        "dermoeczanem_all_products.json": {"format": "json", "encoding": "utf-8"},
    },
    "LOG_LEVEL": "ERROR",
})
